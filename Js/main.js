    ...
    for (let i = 0; i < player.length; i++) {
        ...
        <div class="player${[i + 1]}">
            ...
            <div class="lifetimeStats">
                ...
                <p>${player[i].lifeTimeStats[12].key}:</p><p>${player[i].lifeTimeStats[12].value}</p>
            </div>
        </div>
    `;
    }
    ...
    fortniteInfo += `
        <div class="comparePlayers">
            ...
            <div class="player1compare">
                ...
                <div class="scorePerMatch ">
                    <p>${player1.scorePerMatch.label}</p>
                    <p>${player1.scorePerMatch.displayValue}</p>
                    <div class="progressbar">
                        <div class="progress" style="width: ${100 - +player1.scorePerMatch.percentile}%;"></div>
                    </div>
                </div>
            </div>
            ...
            <div class="player2compare">
                ...
                <div class="scorePerMatch">
                    <div class="progressbar">
                        <div class="progress" style="width: ${100 - +player2.scorePerMatch.percentile}%;"></div>
                    </div>
                    <p>${player2.scorePerMatch.label}</p>
                    <p>${player2.scorePerMatch.displayValue}</p>
                </div>
            </div>
